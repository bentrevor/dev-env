...
(progn
  ...
  (add-to-list 'custom-theme-load-path "~/.emacs.d/mine/themes/")
...
\"###########.######\" };")) t)
 ...
 '(package-selected-packages
   (quote
    (epl rainbow-mode dockerfile-mode yaml-mode web-mode elm-mode org haskell-mode badger-theme whole-line-or-region smartrep magit highlight-numbers helm-projectile expand-region)))
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(widget-field ((t (:background "brightblack" :foreground "white")))))
