...
\"###########.######\" };")) t)
 ...
 '(package-selected-packages
   (quote
    (web-mode elm-mode ag helm-ag tuareg base16-theme org anti-zenburn-theme reverse-theme haskell-mode badger-theme whole-line-or-region smartrep magit highlight-numbers helm-projectile expand-region)))
...
(custom-set-faces
 ...
 '(ag-match-face ((t (:background "color-203" :foreground "black"))))
 ...
 '(magit-diff-added ((t (:background "color-225" :foreground "white"))))
 '(magit-diff-added-highlight ((t (:background "color-224" :foreground "white"))))
 '(magit-diff-context-highlight ((t (:background "color-254" :foreground "white"))))
 '(magit-diff-hunk-heading ((t (:background "color-229"))))
 '(magit-diff-hunk-heading-highlight ((t (:background "color-223"))))
 '(magit-diff-removed ((t (:background "color-159" :foreground "white"))))
 '(magit-diff-removed-highlight ((t (:background "color-158" :foreground "white"))))
 '(magit-section-highlight ((t (:background "color-254"))))
 ...
 '(org-code ((t (:inherit shadow :background "color-253"))))
