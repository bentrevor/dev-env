...
\"###########.######\" };")) t)
 ...
 '(package-selected-packages
   (quote
    (yaml-mode web-mode elm-mode base16-theme org anti-zenburn-theme reverse-theme haskell-mode badger-theme whole-line-or-region smartrep magit highlight-numbers helm-projectile expand-region)))
...
(custom-set-faces
 ...
 '(magit-branch-local ((t (:foreground "brightmagenta"))))
 '(magit-diff-added ((t (:background "green" :foreground "#ddffdd"))))
 '(magit-diff-added-highlight ((t (:background "color-225" :foreground "color-235"))))
 '(magit-diff-context-highlight ((t (:background "black" :foreground "color-246"))))
 '(magit-diff-removed ((t (:background "red" :foreground "#ffdddd"))))
 '(magit-diff-removed-highlight ((t (:background "color-123" :foreground "color-236"))))
 '(magit-section-heading ((t (:foreground "brightblue" :weight bold))))
 '(magit-section-highlight ((t (:background "color-251"))))
